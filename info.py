...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'FilmMoraSupport')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "🌐 <b>File uploaded by [FilmMoraUpdate](https://t.me/FilmMoraUpdate)</b>⚡\n\n🎦 <b>File Name: </b> <i>{file_caption}</i>\n\n⚙️ <b>Size: </b><i>{file_size}</i>  🔥")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Yᴏᴜʀ Qᴜᴇʀʏ: {query}</b> \nIMDb Dᴀᴛᴀ Bʏ: @FilmMorabot \n\n🏷 Tɪᴛʟᴇ: <a href={url}>{title}</a>\n🎭 Gᴇɴʀᴇs: {genres}\n📆 Yᴇᴀʀ: <a href={url}/releaseinfo>{release_date}</a>\n🌟 Rᴀᴛɪɴɢ: <a href={url}/ratings>{rating}</a> / 10 \n\n🗑️ <b>Tʜɪs Fɪʟᴇ Wɪʟʟ Bᴇ Dᴇʟᴇᴛᴇᴅ Fʀᴏᴍ Hᴇʀᴇ Wɪᴛʜɪɴ 10 Mɪɴᴜᴛᴇ As ɪᴛ Hᴀs Cᴏᴘʏʀɪɢʜᴛ ... !!!</b>")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','SandeepXD7') # WITHOUT @
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'easysky.in') #Always use website url from api section 
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'cb2770075a741ce9d441e3056551ba26c9330dd7')
LZURL_PRIME_USERS = [int(lazyurlers) if id_pattern.search(lazyurlers) else lazyurlers for lazyurlers in environ.get('LZURL_PRIME_USERS', '1013249029 978684334 5404010420 1608576332').split()]
...
DOWNLOAD_TEXT_URL = "https://t.me/FilmMoraUpdate/2"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/FilmMoraUpdate"
